 ...
 * @ORM\Entity(repositoryClass="IB\PlatformBundle\Repository\ApplicationRepository")
...
class Application
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="IB\PlatformBundle\Entity\Advert", inversedBy="applications")
     ...
     * @ORM\PreRemove
     */
    public function decreaseNbApplication()
    {
